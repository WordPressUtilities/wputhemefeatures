...
add_action('wp_enqueue_scripts', function () {
    ...
    wp_enqueue_style('vanilla-animate-words-css', get_stylesheet_directory_uri() . '/${_SCRIPTDIR}/vanillaAnimateWords/css/vanilla-animate-words.css', array(), '${_SCRIPT_VERSION}');
});
