...
add_action('wp_enqueue_scripts', function () {
    wp_enqueue_script('vanilla-morphhtmlnumber', get_stylesheet_directory_uri() . '/${_SCRIPTDIR}/vanillaMorphHTMLNumber/js/morphhtmlnumber.min.js', array(), '${_SCRIPT_VERSION}', true);
});
